...
class EgzersizAdapter(private val context: Context) :
    ...
    override fun onBindViewHolder(holder: EgzersizViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            Log.d("com.example.foodapp.adapter.EgzersizAdapter", "Tıklanan egzersiz: ${currentItem.egzersizAdi}")
        ...
        holder.checkBox.setOnCheckedChangeListener { buttonView, isChecked ->
            ...
            if (isChecked) {
                ...
                selectedCount++
                Log.d("com.example.foodapp.adapter.EgzersizAdapter", "Seçilen egzersiz: ${currentItem.egzersizAdi}")
            } else {
